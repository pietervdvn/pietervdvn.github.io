...
group: hidden`,anyOf:[{$ref:"#/definitions/Record<string,string>"},{type:"string"}]}},additionalProperties:!1},"Partial<any>":{type:"object",additionalProperties:!1},RasterLayerProperties:{description:"This class has grown beyond the point of only containing Raster Layers",type:"object",properties:{name:{description:"The name of the imagery source",anyOf:[{$ref:"#/definitions/Record<string,string>"},{type:"string"}]},isOverlay:{type:"boolean"},id:{type:"string"},url:{type:"string"},category:{type:"string"},type:{type:"string"},style:{type:"string"},attribution:{type:"object",properties:{url:{type:"string"},text:{type:"string"},html:{type:"string"},required:{type:"boolean"}}},min_zoom:{type:"number"},max_zoom:{type:"number"},best:{type:"boolean"}},required:["id","name","url"],additionalProperties:!1}},Fl="http://json-schema.org/draft-07/schema#",Ll=!1,Pl={description:Wl,type:Ol,properties:Ml,required:Nl,definitions:Dl,$schema:Fl,additionalProperties:Ll};function El(o){let e,t,n=!o[2]&&si();return{c(){e=q("div"),n&&n.c(),k(e,"class","h-full w-full")},m(i,s){b(i,e,s),n&&n.m(e,null),o[7](e),t=!0},p(i,s){i[2]?n&&(K(),f(n,1,1,()=>{n=null}),ee()):n?s&4&&u(n,1):(n=si(),n.c(),u(n,1),n.m(e,null))},i(i){t||(u(n),t=!0)},o(i){f(n),t=!1},d(i){i&&y(e),n&&n.d(),o[7](null)}}}function Hl(o){let e,t,n;return{c(){e=q("textarea"),k(e,"class","w-full"),k(e,"rows","25")},m(i,s){b(i,e,s),ze(e,o[3]),t||(n=te(e,"input",o[6]),t=!0)},p(i,s){s&8&&ze(e,i[3])},i:H,o:H,d(i){i&&y(e),t=!1,n()}}}function si(o){let e,t,n;return t=new Mo({}),{c(){e=q("div"),R(t.$$.fragment),k(e,"class","align-center flex h-full w-full items-center")},m(i,s){b(i,e,s),A(t,e,null),n=!0},i(i){n||(u(t.$$.fragment,i),n=!0)},o(i){f(t.$$.fragment,i),n=!1},d(i){i&&y(e),S(t)}}}function Ul(o){let e,t,n,i;const s=[Hl,El],a=[];function l(r,h){return r[1]?0:1}return e=l(o),t=a[e]=s[e](o),{c(){t.c(),n=re()},m(r,h){a[e].m(r,h),b(r,n,h),i=!0},p(r,[h]){let d=e;e=l(r),e===d?a[e].p(r,h):(K(),f(a[d],1,1,()=>{a[d]=null}),ee(),t=a[e],t?t.p(r,h):(t=a[e]=s[e](r),t.c()),u(t,1),t.m(n.parentNode,n))},i(r){i||(u(t),i=!0)},o(r){f(t),i=!1},d(r){a[e].d(r),r&&y(n)}}}function Bl(o,e,t){let n,{state:i}=e,s=i.configuration.sync(w=>JSON.stringify(w,null,"  "),[],w=>{try{return JSON.parse(w)}catch{console.error("Could not parse",w);return}});ne(o,s,w=>t(3,n=w));let a,l,r,h;function d(){try{const w=JSON.parse(r.getValue());i.configuration.setData(w)}catch(w){console.error(w)}}Tt(()=>{const w=v=>{v.key==="s"&&(v.ctrlKey||v.metaKey)&&(v.preventDefault(),d())};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)});let p=!1,c=!1;Tt(async()=>{var j,W,V,T,P,O;const w=await Oo(()=>import("./editor.main-1f6555e5.js").then(L=>L.e),["./editor.main-1f6555e5.js","./FloatOver-49a45e03.js","./index-b6509830.js","./UIEventSource-ce56c40b.js","./tw-merge-6d4dccad.js","./Constants-c9f38f96.js","./tw-join-70ce42f3.js","./InputHelper-c82cab17.js","./Searchbar-6f1db6ed.js","./Checkbox-d763d61b.js","./Loading-59ac8633.js","./Dropdown-f6f72b8a.js","./InputHelper-3adf946e.css","./FloatOver-3670e43d.css","./editor-a89423dd.css"],import.meta.url);oi.config({monaco:w.default});try{l=await oi.init()}catch(L){console.error("Could not load Monaco Editor, falling back",L),t(1,p=!0)}let v;i instanceof Ii?v="https://mapcomplete.org/schemas/layerconfig.json":v="https://mapcomplete.org/schemas/layoutconfig.json",(V=(W=(j=l==null?void 0:l.languages)==null?void 0:j.json)==null?void 0:W.jsonDefaults)==null||V.setDiagnosticsOptions({validate:!0,schemas:[{uri:v,fileMatch:["file.json"],schema:v==="https://mapcomplete.org/schemas/layerconfig.json"?Jl:Pl}]});let $=(T=l==null?void 0:l.Uri)==null?void 0:T.parse("inmemory://inmemory/file.json");try{h=(P=l==null?void 0:l.editor)==null?void 0:P.createModel(JSON.stringify(i.configuration.data,null,"  "),"json",$)}catch(L){console.error("Could not create model in MOnaco Editor",L),t(1,p=!0)}r=(O=l==null?void 0:l.editor)==null?void 0:O.create(a,{model:h,automaticLayout:!0});let N;r==null||r.onDidChangeModelContent(()=>{clearTimeout(N),N=setTimeout(()=>{d()},500)}),t(2,c=!0)}),dt(()=>{r&&r.dispose(),h&&h.dispose()});function g(){n=this.value,s.set(n)}function _(w){Ne[w?"unshift":"push"](()=>{a=w,t(0,a)})}return o.$$set=w=>{"state"in w&&t(5,i=w.state)},[a,p,c,n,s,i,g,_]}class Ei extends fe{constructor(e){super(),ge(this,e,Bl,Ul,me,{state:5})}}function zl(o){let e,t,n,i,s;return t=new vi({props:{class:"h-6 w-6"}}),{c(){e=q("div"),R(t.$$.fragment),n=J(`
      ...
      might have a backup`,n=I(),R(i.$$.fragment),k(e,"class","flex flex-col")},m(a,l){b(a,e,l),m(e,t),m(e,n),A(i,e,null),s=!0},p(a,l){const r={};l&33&&(r.$$scope={dirty:l,ctx:a}),i.$set(r)},i(a){s||(u(i.$$.fragment,a),s=!0)},o(a){f(i.$$.fragment,a),s=!1},d(a){a&&y(e),S(i)}}}function Ql(o){let e,t,n,i,s;return t=new vi({props:{class:"h-6 w-6"}}),{c(){e=q("div"),R(t.$$.fragment),n=J(`
...
//# sourceMappingURL=studio-d8d7c5f0.js.map
