...
},{"../Logic/UIEventSource":"Logic/UIEventSource.ts","../Utils":"Utils.ts"}],"UI/MapControlButton.ts":[function(require,module,exports) {
"use strict";
...
var MapControlButton =
/** @class */
function (_super) {
  __extends(MapControlButton, _super);

  function MapControlButton(contents) {
    var _this = _super.call(this) || this;

    _this._contents = contents;

    _this.SetClass("relative block rounded-full w-10 h-10 p-1 pointer-events-auto z-above-map subtle-background");

    _this.SetStyle("box-shadow: 0 0 10px var(--shadow-color);");

    return _this;
  }

  MapControlButton.prototype.InnerRender = function () {
...
exports.default = MapControlButton;
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","UI/MapControlButton.ts"], null)
//# sourceMappingURL=/UI/MapControlButton.js.map