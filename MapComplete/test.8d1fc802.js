...
},{"../Logic/UIEventSource":"Logic/UIEventSource.ts"}],"UI/Input/InputElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts","./FixedUiElement":"UI/Base/FixedUiElement.ts","../../Utils":"Utils.ts"}],"UI/Img.ts":[function(require,module,exports) {
"use strict";
...
exports.Img = Img;
},{}],"Svg.ts":[function(require,module,exports) {
"use strict";
...
exports.default = Svg;
},{"./UI/Img":"UI/Img.ts","./UI/Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Input/DirectionInput.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(DirectionInput, _super);
  ...
  function DirectionInput(value) {
    ...
    _this.value.addCallbackAndRun(function (rotation) {
      var selfElement = document.getElementById(_this.id);

      if (selfElement === null) {
        return;
      }

      var cone = selfElement.getElementsByClassName("direction-svg")[0];
  ...
  DirectionInput.prototype.GetValue = function () {
    return this.value;
  };

  DirectionInput.prototype.InnerRender = function () {
    return new Combine_1.default(["<div id=\"direction-leaflet-div-" + this.id + "\" style=\"width:100%;height: 100%;position: absolute;top:0;left:0;border-radius:100%;\"></div>", Svg_1.default.direction_svg().SetStyle("position: absolute;top: 0;left: 0;width: 100%;height: 100%;rotate:" + this.value.data + "deg;").SetClass("direction-svg"), Svg_1.default.compass_svg().SetStyle("position: absolute;top: 0;left: 0;width: 100%;height: 100%;")]).SetStyle("position:relative;display:block;width: min(100%, 25em); padding-top: min(100% , 25em); background:white; border: 1px solid black; border-radius: 999em").Render();
  };

  DirectionInput.prototype.InnerUpdate = function (htmlElement) {
    _super.prototype.InnerUpdate.call(this, htmlElement);

    var self = this;

    function onPosChange(x, y) {
      var rect = htmlElement.getBoundingClientRect();
      var dx = -(rect.left + rect.right) / 2 + x;
      var dy = (rect.top + rect.bottom) / 2 - y;
      var angle = 180 * Math.atan2(dy, dx) / Math.PI;
      var angleGeo = Math.floor((450 - angle) % 360);
      self.value.setData("" + angleGeo);
    }

    htmlElement.ontouchmove = function (ev) {
      onPosChange(ev.touches[0].clientX, ev.touches[0].clientY);
      ev.preventDefault();
    };

    htmlElement.ontouchstart = function (ev) {
      onPosChange(ev.touches[0].clientX, ev.touches[0].clientY);
    };

    var isDown = false;

    htmlElement.onmousedown = function (ev) {
      isDown = true;
      onPosChange(ev.x, ev.y);
      ev.preventDefault();
    };

    htmlElement.onmouseup = function (ev) {
      isDown = false;
      ev.preventDefault();
    };

    htmlElement.onmousemove = function (ev) {
      if (isDown) {
        onPosChange(ev.x, ev.y);
      }
  ...
  DirectionInput.prototype.IsValid = function (str) {
    var t = Number(str);
...
exports.default = DirectionInput;
},{"./InputElement":"UI/Input/InputElement.ts","../../Logic/UIEventSource":"Logic/UIEventSource.ts","../Base/Combine":"UI/Base/Combine.ts","../../Svg":"Svg.ts"}],"UI/Base/VariableUIElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"test.ts":[function(require,module,exports) {
"use strict"; //*
...
var DirectionInput_1 = __importDefault(require("./UI/Input/DirectionInput"));

var UIEventSource_1 = require("./Logic/UIEventSource");

var VariableUIElement_1 = require("./UI/Base/VariableUIElement");

var d = new UIEventSource_1.UIEventSource("90");
new DirectionInput_1.default(d).AttachTo("maindiv");
new VariableUIElement_1.VariableUiElement(d.map(function (d) {
  return "" + d + "°";
})).AttachTo("extradiv");
UIEventSource_1.UIEventSource.Chronic(25, function () {
  var degr = (Number(d.data) + 1) % 360;
  d.setData("" + degr);
  return true;
});
/*/
...
//*/
},{"./UI/Input/DirectionInput":"UI/Input/DirectionInput.ts","./Logic/UIEventSource":"Logic/UIEventSource.ts","./UI/Base/VariableUIElement":"UI/Base/VariableUIElement.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
