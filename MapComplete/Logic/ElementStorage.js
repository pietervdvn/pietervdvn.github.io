...
},{"../Utils":"Utils.ts"}],"Logic/ElementStorage.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  ElementStorage.prototype.addOrGetElement = function (feature) {
    var elementId = feature.properties.id;
    ...
    if (elementId in this._elements) {
      ...
      var eventSource = new UIEventSource_1.UIEventSource(feature.properties, "tags of " + feature.properties.id);
      this._elements[feature.properties.id] = eventSource;
      return eventSource;
    }
  };

  ElementStorage.prototype.getEventSourceById = function (elementId) {
    if (elementId in this._elements) {
...
},{"./UIEventSource":"Logic/UIEventSource.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
