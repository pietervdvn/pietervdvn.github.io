...
},{"ohauth":"node_modules/ohauth/index.js","resolve-url":"node_modules/resolve-url/resolve-url.js","store":"node_modules/store/dist/store.legacy.js","xtend":"node_modules/xtend/immutable.js"}],"Logic/UIEventSource.ts":[function(require,module,exports) {
"use strict";
...
exports.Utils = Utils;
},{"./UI/UIElement":"UI/UIElement.ts","jquery":"node_modules/jquery/dist/jquery.js","./UI/Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"Logic/Osm/OsmPreferences.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIEventSource":"Logic/UIEventSource.ts","../../Utils":"Utils.ts"}],"Logic/ElementStorage.ts":[function(require,module,exports) {
"use strict";
...
},{"./OsmObject":"Logic/Osm/OsmObject.ts","../Tags":"Logic/Tags.ts","../../State":"State.ts","../../Utils":"Utils.ts"}],"Logic/Web/LocalStorageSource.ts":[function(require,module,exports) {
"use strict";
...
exports.State = State;
},{"./Utils":"Utils.ts","./Logic/ElementStorage":"Logic/ElementStorage.ts","./Logic/Osm/Changes":"Logic/Osm/Changes.ts","./Logic/Osm/OsmConnection":"Logic/Osm/OsmConnection.ts","./UI/i18n/Locale":"UI/i18n/Locale.ts","./UI/i18n/Translations":"UI/i18n/Translations.ts","./Logic/UIEventSource":"Logic/UIEventSource.ts","./Logic/Web/LocalStorageSource":"Logic/Web/LocalStorageSource.ts","./Logic/Web/QueryParameters":"Logic/Web/QueryParameters.ts"}],"Logic/Osm/ChangesetHandler.ts":[function(require,module,exports) {
"use strict";
...
},{"osm-auth":"node_modules/osm-auth/index.js","../UIEventSource":"Logic/UIEventSource.ts","./OsmPreferences":"Logic/Osm/OsmPreferences.ts","./ChangesetHandler":"Logic/Osm/ChangesetHandler.ts"}],"UI/Base/Button.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts","../i18n/Locale":"UI/i18n/Locale.ts","../i18n/Translations":"UI/i18n/Translations.ts"}],"UI/Input/InputElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"UI/Input/TextField.ts":[function(require,module,exports) {
"use strict";
...
},{"./InputElement":"UI/Input/InputElement.ts","../i18n/Translations":"UI/i18n/Translations.ts","../../Logic/UIEventSource":"Logic/UIEventSource.ts"}],"preferences.ts":[function(require,module,exports) {
"use strict";
...
var Button_1 = require("./UI/Base/Button");
...
var connection = new OsmConnection_1.OsmConnection(false, new UIEventSource_1.UIEventSource(undefined), "");
var rendered = false;

function createTable(preferences) {
  if (rendered) {
    return;
  }
  ...
  var _loop_1 = function _loop_1(key) {
    console.log(key);
    var pref = connection.GetPreference(key, "");
    var value = new FixedUiElement_1.FixedUiElement(pref.data);

    if (connection.userDetails.data.csCount > 500 && (key.startsWith("mapcomplete") || connection.userDetails.data.csCount > 2500)) {
      value = new TextField_1.TextField({
    ...
    var c = ["<tr><td>", key, "</td><td>", new Button_1.Button("delete", function () {
      return pref.setData("");
    }), "</td><td>", value, "</td></tr>"];
    prefs.push.apply(prefs, c);
  };
  ...
  var el = new Combine_1.default(__spreadArrays(["<table>"], prefs, ["</table>"])); // .AttachTo("maindiv");

  console.log(el.InnerRender());
  el.AttachTo("maindiv");
}

connection.preferencesHandler.preferences.addCallback(function (prefs) {
  return createTable(prefs);
});
},{"./Logic/Osm/OsmConnection":"Logic/Osm/OsmConnection.ts","./UI/Base/Combine":"UI/Base/Combine.ts","./UI/Base/Button":"UI/Base/Button.ts","./UI/Input/TextField":"UI/Input/TextField.ts","./UI/Base/FixedUiElement":"UI/Base/FixedUiElement.ts","./Logic/UIEventSource":"Logic/UIEventSource.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","preferences.ts"], null)
//# sourceMappingURL=/preferences.64de738e.js.map