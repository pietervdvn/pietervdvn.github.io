...
function (_super) {
  ...
  function MoreScreen() {
    var _this = _super.call(this, State_1.default.state.locationControl) || this;

    _this.ListenTo(State_1.default.state.osmConnection.userDetails);

    _this.ListenTo(State_1.default.state.installedThemes);
  ...
  MoreScreen.prototype.createLinkButton = function (layout, customThemeDefinition) {
    ...
    if (layout.hideFromOverview) {
      var pref = State_1.default.state.osmConnection.GetPreference("hidden-theme-" + layout.id + "-enabled");
      this.ListenTo(pref);
    ...
    if (layout.id === State_1.default.state.layoutToUse.data.id) {
      return undefined;
    }

    var currentLocation = State_1.default.state.locationControl.data;
  ...
  MoreScreen.prototype.InnerRender = function () {
    ...
    var els = [];
    els.push(new VariableUIElement_1.VariableUiElement(State_1.default.state.osmConnection.userDetails.map(function (userDetails) {
    ...
    for (var k in AllKnownLayouts_1.AllKnownLayouts.allSets) {
      ...
      if (k === PersonalLayout_1.PersonalLayout.NAME) {
        if (State_1.default.state.osmConnection.userDetails.data.csCount < State_1.default.userJourney.personalLayoutUnlock) {
          continue;
        }
      }
    ...
    var customThemesNames = (_a = State_1.default.state.installedThemes.data) !== null && _a !== void 0 ? _a : [];

    if (customThemesNames.length > 0) {
      els.push(Translations_1.default.t.general.customThemeIntro);

      for (var _i = 0, _b = State_1.default.state.installedThemes.data; _i < _b.length; _i++) {
        var installed = _b[_i];
