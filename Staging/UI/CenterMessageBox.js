...
exports.State = State;
},{"./Utils":"Utils.ts","./Logic/ElementStorage":"Logic/ElementStorage.ts","./Logic/Osm/Changes":"Logic/Osm/Changes.ts","./Logic/Osm/OsmConnection":"Logic/Osm/OsmConnection.ts","./UI/i18n/Locale":"UI/i18n/Locale.ts","./UI/i18n/Translations":"UI/i18n/Translations.ts","./Logic/UIEventSource":"Logic/UIEventSource.ts","./Logic/Web/LocalStorageSource":"Logic/Web/LocalStorageSource.ts","./Logic/Web/QueryParameters":"Logic/Web/QueryParameters.ts"}],"UI/CenterMessageBox.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function CenterMessageBox() {
    var _this = _super.call(this, State_1.State.state.centerMessage) || this;

    _this.ListenTo(State_1.State.state.locationControl);

    _this.ListenTo(State_1.State.state.layerUpdater.retries);

    _this.ListenTo(State_1.State.state.layerUpdater.runningQuery);

    _this.ListenTo(State_1.State.state.layerUpdater.sufficentlyZoomed);

    return _this;
  }

  CenterMessageBox.prep = function () {
    if (State_1.State.state.centerMessage.data != "") {
      return {
        innerHtml: State_1.State.state.centerMessage.data,
        done: false
      };
    }

    var lu = State_1.State.state.layerUpdater;

    if (lu.retries.data > 0) {
      return {
        innerHtml: Translations_1.default.t.centerMessage.retrying.Subs({
          count: "" + lu.retries.data
        }).Render(),
        done: false
      };
    }
    ...
    if (lu.runningQuery.data) {
      return {
        innerHtml: Translations_1.default.t.centerMessage.loadingData.Render(),
        done: false
      };
    }
    ...
    if (!lu.sufficentlyZoomed.data) {
      return {
        innerHtml: Translations_1.default.t.centerMessage.zoomIn.Render(),
        done: false
      };
    } else {
      return {
        innerHtml: Translations_1.default.t.centerMessage.ready.Render(),
        done: true
      };
    }
  };
...
},{"./UIElement":"UI/UIElement.ts","./i18n/Translations":"UI/i18n/Translations.ts","../State":"State.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
