...
},{"./Translation":"UI/i18n/Translation.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Input/CheckBox.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts","../../UI/i18n/Translations":"UI/i18n/Translations.ts","../../Logic/UIEventSource":"Logic/UIEventSource.ts"}],"Logic/ElementStorage.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"UI/LayerSelection.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function LayerSelection() {
    ...
    var _loop_1 = function _loop_1(layer) {
      var iconUrl = "./asets/checkbox.svg";
      var iconUrlBlank = "";

      if (layer.layerDef.icon && layer.layerDef.icon !== "") {
        iconUrl = layer.layerDef.icon;
        iconUrlBlank = layer.layerDef.icon;
      }

      var icon = new FixedUiElement_1.FixedUiElement("<img style=\"height:2em;max-width: 2em;\" src=\"" + iconUrl + "\">");
      var iconUnselected = void 0;
      iconUnselected = new FixedUiElement_1.FixedUiElement("<img style=\"height:2em;max-width: 2em; opacity:0.2;\" src=\"" + iconUrl + "\">");
      var name = Translations_1.default.WT(layer.layerDef.name).Clone().SetStyle("font-size:large;margin-left: 0.5em;");
      var zoomStatus = new VariableUIElement_1.VariableUiElement(State_1.State.state.locationControl.map(function (location) {
        if (location.zoom < layer.layerDef.minzoom) {
          return Translations_1.default.t.general.zoomInToSeeThisLayer.SetClass("alert").SetStyle("display: block ruby;width:min-content;").Render();
        }
      ...
      this_1._checkboxes.push(new CheckBox_1.CheckBox(new Combine_1.default([icon, name, zoomStatus]).SetStyle(style), new Combine_1.default([iconUnselected, "<del>", name, "</del>", zoomStatus]).SetStyle(style), layer.isDisplayed).SetStyle("margin:0.3em;"));
    };
  ...
  LayerSelection.prototype.InnerRender = function () {
    return new Combine_1.default(this._checkboxes).SetStyle("display:flex;flex-direction:column;").Render();
  };
...
},{"./UIElement":"UI/UIElement.ts","./Input/CheckBox":"UI/Input/CheckBox.ts","./Base/Combine":"UI/Base/Combine.ts","../State":"State.ts","./i18n/Translations":"UI/i18n/Translations.ts","./Base/FixedUiElement":"UI/Base/FixedUiElement.ts","./Base/VariableUIElement":"UI/Base/VariableUIElement.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
