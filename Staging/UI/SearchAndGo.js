...
},{"../UIElement":"UI/UIElement.ts","../../Logic/Web/LocalStorageSource":"Logic/Web/LocalStorageSource.ts"}],"UI/Base/VariableUIElement.ts":[function(require,module,exports) {
"use strict";
...
},{"./Translation":"UI/i18n/Translation.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Input/TextField.ts":[function(require,module,exports) {
"use strict";
...
},{"./InputElement":"UI/Input/InputElement.ts","../i18n/Translations":"UI/i18n/Translations.ts","../../Logic/UIEventSource":"Logic/UIEventSource.ts"}],"node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"node_modules/process/browser.js"}],"Logic/ElementStorage.ts":[function(require,module,exports) {
"use strict";
...
exports.State = State;
},{"./Utils":"Utils.ts","./Logic/ElementStorage":"Logic/ElementStorage.ts","./Logic/Osm/Changes":"Logic/Osm/Changes.ts","./Logic/Osm/OsmConnection":"Logic/Osm/OsmConnection.ts","./UI/i18n/Locale":"UI/i18n/Locale.ts","./UI/i18n/Translations":"UI/i18n/Translations.ts","./Logic/UIEventSource":"Logic/UIEventSource.ts","./Logic/Web/LocalStorageSource":"Logic/Web/LocalStorageSource.ts","./Logic/Web/QueryParameters":"Logic/Web/QueryParameters.ts"}],"Logic/Osm/Geocoding.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Geocoding.Search = function (query, handleResult, onFail) {
    var b = State_1.State.state.bm.map.getBounds();
    console.log(b);
    jquery_1.default.getJSON(Geocoding.host + "format=json&limit=1&viewbox=" + (b.getEast() + "," + b.getNorth() + "," + b.getWest() + "," + b.getSouth()) + "&accept-language=nl&q=" + query, function (data) {
      handleResult(data);
    }).fail(function () {
      onFail();
    });
...
},{"jquery":"node_modules/jquery/dist/jquery.js","../../State":"State.ts"}],"UI/SearchAndGo.ts":[function(require,module,exports) {
"use strict";
...
var Geocoding_1 = require("../Logic/Osm/Geocoding");
...
function (_super) {
  ...
  SearchAndGo.prototype.RunSearch = function () {
    ...
    var self = this;
    Geocoding_1.Geocoding.Search(searchString, function (result) {
      console.log("Search result", result);

      if (result.length == 0) {
        self._placeholder.setData(Translations_1.default.t.general.search.nothing);
      ...
      State_1.State.state.bm.map.fitBounds(bounds);

      self._placeholder.setData(Translations_1.default.t.general.search.search);
    }, function () {
      self._searchField.GetValue().setData("");

      self._placeholder.setData(Translations_1.default.t.general.search.error);
    });
  };
...
},{"./i18n/Locale":"UI/i18n/Locale.ts","./UIElement":"UI/UIElement.ts","./Base/VariableUIElement":"UI/Base/VariableUIElement.ts","./Base/FixedUiElement":"UI/Base/FixedUiElement.ts","./Input/TextField":"UI/Input/TextField.ts","../Logic/Osm/Geocoding":"Logic/Osm/Geocoding.ts","./i18n/Translations":"UI/i18n/Translations.ts","../State":"State.ts","../Logic/UIEventSource":"Logic/UIEventSource.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
