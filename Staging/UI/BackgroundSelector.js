...
},{"./Translation":"UI/i18n/Translation.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Input/DropDown.ts":[function(require,module,exports) {
"use strict";
...
exports.State = State;
},{"./Utils":"Utils.ts","./Logic/ElementStorage":"Logic/ElementStorage.ts","./Logic/Osm/Changes":"Logic/Osm/Changes.ts","./Logic/Osm/OsmConnection":"Logic/Osm/OsmConnection.ts","./UI/i18n/Locale":"UI/i18n/Locale.ts","./UI/i18n/Translations":"UI/i18n/Translations.ts","./Logic/UIEventSource":"Logic/UIEventSource.ts","./Logic/Web/LocalStorageSource":"Logic/Web/LocalStorageSource.ts","./Logic/Web/QueryParameters":"Logic/Web/QueryParameters.ts"}],"UI/BackgroundSelector.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function BackgroundSelector() {
    ...
    var self = _this;
    _this._availableLayers = State_1.State.state.availableBackgroundLayers;

    _this._availableLayers.addCallbackAndRun(function (available) {
      return self.CreateDropDown(available);
    });

    return _this;
  }

  BackgroundSelector.prototype.CreateDropDown = function (available) {
    var _a;
    ...
    for (var i in available) {
      var layer = available[i];
      baseLayers.push({
        value: layer,
        shown: (_a = layer.name) !== null && _a !== void 0 ? _a : "id:" + layer.id
      });
    }

    this._dropdown = new DropDown_1.DropDown(Translations_1.default.t.general.backgroundMap, baseLayers, State_1.State.state.bm.CurrentLayer);
  };

  BackgroundSelector.prototype.InnerRender = function () {
...
exports.default = BackgroundSelector;
},{"./UIElement":"UI/UIElement.ts","./Input/DropDown":"UI/Input/DropDown.ts","./i18n/Translations":"UI/i18n/Translations.ts","../State":"State.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","UI/BackgroundSelector.ts"], null)
//# sourceMappingURL=/UI/BackgroundSelector.js.map