...
},{"./UIEventSource":"Logic/UIEventSource.ts"}],"node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"node_modules/process/browser.js"}],"Logic/Osm/OsmObject.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  OsmObject.Escape = function (string) {
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"Logic/Tags.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function ShareScreen(layout, layoutDefinition) {
    ...
    layout = layout !== null && layout !== void 0 ? layout : (_b = (_a = State_1.State.state) === null || _a === void 0 ? void 0 : _a.layoutToUse) === null || _b === void 0 ? void 0 : _b.data;
    layoutDefinition = layoutDefinition !== null && layoutDefinition !== void 0 ? layoutDefinition : (_c = State_1.State.state) === null || _c === void 0 ? void 0 : _c.layoutDefinition;
    var tr = Translations_1.default.t.general.sharescreen;
    var optionCheckboxes = [];
    var optionParts = [];
    var includeLocation = new CheckBox_1.CheckBox(new Combine_1.default([Img_1.Img.checkmark, tr.fsIncludeCurrentLocation]), new Combine_1.default([Img_1.Img.no_checkmark, tr.fsIncludeCurrentLocation]), true);
    optionCheckboxes.push(includeLocation);
    var currentLocation = (_d = State_1.State.state) === null || _d === void 0 ? void 0 : _d.locationControl;
    ...
    if (State_1.State.state !== undefined) {
      var currentLayer_1 = State_1.State.state.bm.CurrentLayer;
      var currentBackground = new VariableUIElement_1.VariableUiElement(currentLayer_1.map(function (layer) {
        ...
        return tr.fsIncludeCurrentBackgroundMap.Subs({
          name: (_a = layer === null || layer === void 0 ? void 0 : layer.id) !== null && _a !== void 0 ? _a : ""
        }).Render();
      }));
      var includeCurrentBackground = new CheckBox_1.CheckBox(new Combine_1.default([Img_1.Img.checkmark, currentBackground]), new Combine_1.default([Img_1.Img.no_checkmark, currentBackground]), true);
      ...
      var includeLayerChoices = new CheckBox_1.CheckBox(new Combine_1.default([Img_1.Img.checkmark, tr.fsIncludeCurrentLayers]), new Combine_1.default([Img_1.Img.no_checkmark, tr.fsIncludeCurrentLayers]), true);
      optionCheckboxes.push(includeLayerChoices);
      optionParts.push(includeLayerChoices.isEnabled.map(function (includeLayerSelection) {
        if (includeLayerSelection) {
          return Utils_1.Utils.NoNull(State_1.State.state.filteredLayers.data.map(fLayerToParam)).join("&");
        } else {
          return null;
        }
      }, State_1.State.state.filteredLayers.data.map(function (flayer) {
    ...
    var _loop_1 = function _loop_1(swtch) {
      var checkbox = new CheckBox_1.CheckBox(new Combine_1.default([Img_1.Img.checkmark, Translations_1.default.W(swtch.human)]), new Combine_1.default([Img_1.Img.no_checkmark, Translations_1.default.W(swtch.human)]), !swtch.reverse);
    ...
    _this.iframe = url.map(function (url) {
      ...
      return "&lt;iframe src=\"" + url + "\" width=\"100%\" height=\"100%\" title=\"" + ((_b = (_a = layout.title) === null || _a === void 0 ? void 0 : _a.InnerRender()) !== null && _b !== void 0 ? _b : "") + " with MapComplete\"&gt;&lt;/iframe&gt";
    });
    ...
    if (layoutDefinition !== undefined && ((_e = State_1.State.state) === null || _e === void 0 ? void 0 : _e.osmConnection) !== undefined) {
      _this._editLayout = new VariableUIElement_1.VariableUiElement(State_1.State.state.osmConnection.userDetails.map(function (userDetails) {
        ...
        return new SubtleButton_1.SubtleButton("./assets/pencil.svg", new Combine_1.default([tr.editThisTheme.SetClass("bold"), "<br/>", tr.editThemeDescription]), {
          url: "./customGenerator.html#" + State_1.State.state.layoutDefinition,
          newTab: true
        }).Render();
      }));
    }
