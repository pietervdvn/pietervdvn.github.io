...
function (_super) {
  ...
  Translation.prototype.EvaluateSpecialComponents = function (knownSpecials) {
    var newTranslations = {};

    for (var lang in this.translations) {
      var template = this.translations[lang];

      for (var _i = 0, knownSpecials_1 = knownSpecials; _i < knownSpecials_1.length; _i++) {
        var knownSpecial = knownSpecials_1[_i];
        var matched = template.match("(.*){" + knownSpecial.funcName + "\\((.*)\\)}(.*)");

        if (matched === null) {
          continue;
        }

        var partBefore = matched[1];
        var argument = matched[2];
        var partAfter = matched[3];

        try {
          var element = knownSpecial.constr(argument).Render();
...
function () {
  ...
  Translations.WT = function (s) {
    ...
    if (s instanceof Translation_1.default) {
      return s;
    }
  ...
  Translations.t = {
    ...
    general: {
      ...
      weekdays: {
        abbreviations: {
          monday: new Translation_2.default({
            "en": "Mon",
            "nl": "Maan",
            "fr": "Lun"
          }),
          tuesday: new Translation_2.default({
            "en": "Tue",
            "nl": "Din",
            "fr": "Mar"
          }),
          wednesday: new Translation_2.default({
            "en": "Wed",
            "nl": "Woe",
            "fr": "Mercr"
          }),
          thursday: new Translation_2.default({
            "en": "Thu",
            "nl": "Don",
            "fr": "Jeudi"
          }),
          friday: new Translation_2.default({
            "en": "Fri",
            "nl": "Vrij",
            "fr": "Vendr"
          }),
          saturday: new Translation_2.default({
            "en": "Sat",
            "nl": "Zat",
            "fr": "Sam"
          }),
          sunday: new Translation_2.default({
            "en": "Sun",
            "nl": "Zon",
            "fr": "Dim"
          })
      ...
      opening_hours: {
        open_during_ph: new Translation_2.default({
          "nl": "Op een feestdag is deze zaak",
          "en": "During a public holiday, this amenity is"
        }),
        opensAt: new Translation_2.default({
          "en": "from",
          "nl": "vanaf"
        }),
        openTill: new Translation_2.default({
          "en": "till",
          "nl": "tot"
        }),
        not_all_rules_parsed: new Translation_2.default({
          "en": "The openin hours of this shop are complicated. The following rules are ignored in the input element:"
        }),
        closed_until: new Translation_2.default({
          "en": "Closed until {date}",
          "nl": "Gesloten - open op {date}"
        }),
        closed_permanently: new Translation_2.default({
          "en": "Closed - no opening day known",
          "nl": "Gesloten"
        }),
        ph_not_known: new Translation_2.default({
          "en": " ",
          "nl": " "
        }),
        ph_closed: new Translation_2.default({
          "en": "closed",
          "nl": "gesloten"
        }),
        ph_open: new Translation_2.default({
          "en": "opened",
          "nl": "open"
        })
      }
...
},{"./Translation":"UI/i18n/Translation.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Base/VariableUIElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"UI/Input/CheckBox.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts","../../UI/i18n/Translations":"UI/i18n/Translations.ts","../../Logic/UIEventSource":"Logic/UIEventSource.ts"}],"UI/Base/VerticalCombine.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"UI/Img.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Img.checkmark = "<svg width=\"26\" height=\"18\" viewBox=\"0 0 26 18\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M3 7.28571L10.8261 15L23 3\" stroke=\"black\" stroke-width=\"4\" stroke-linejoin=\"round\"/></svg>";
  Img.no_checkmark = "<svg width=\"26\" height=\"18\" viewBox=\"0 0 26 18\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"></svg>";
...
function () {
  ...
  Changes.prototype.addTag = function (elementId, tagsFilter) {
    ...
    var eventSource = State_1.default.state.allElements.getElement(elementId);
  ...
  Changes.prototype.createElement = function (basicTags, lat, lon) {
    ...
    State_1.default.state.allElements.addOrGetElement(geojson).ping();
  ...
  Changes.prototype.uploadChangesWithLatestVersions = function (knownElements, newElements, pending) {
    ...
    State_1.default.state.osmConnection.UploadChangeset(State_1.default.state.layoutToUse.data, State_1.default.state.allElements, function (csId) {
      var modifications = "";
      ...
      var changes = "<osmChange version='0.6' generator='Mapcomplete " + State_1.default.vNumber + "'>";
...
function () {
  ...
  ChangesetHandler.prototype.OpenChangeset = function (layout, continuation) {
    ...
    if (State_1.default.state.currentGPSLocation.data !== undefined) {
    ...
    this.auth.xhr({
      ...
      content: ["<osm><changeset>", "<tag k=\"created_by\" v=\"MapComplete " + State_1.default.vNumber + "\" />", "<tag k=\"comment\" v=\"Adding data with #MapComplete for theme #" + layout.id + commentExtra + "\"/>", "<tag k=\"theme\" v=\"" + layout.id + "\"/>", "<tag k=\"language\" v=\"" + Locale_1.default.language.data + "\"/>", surveySource, layout.maintainer !== undefined ? "<tag k=\"theme-creator\" v=\"" + layout.maintainer + "\"/>" : "", "</changeset></osm>"].join("")
...
function () {
    ...
    this.installedThemes = this.osmConnection.preferencesHandler.preferences.map(function (allPreferences) {
      ...
      for (var allPreferencesKey in allPreferences) {
        ...
        if (themename && themename[1] !== "") {
          var customLayout = self.osmConnection.GetLongPreference("installed-theme-" + themename[1]);
  ...
  State.vNumber = "0.1.0d"; // The user journey states thresholds when a new feature gets unlocked
...
},{"./Utils":"Utils.ts","./Logic/ElementStorage":"Logic/ElementStorage.ts","./Logic/Osm/Changes":"Logic/Osm/Changes.ts","./Logic/Osm/OsmConnection":"Logic/Osm/OsmConnection.ts","./UI/i18n/Locale":"UI/i18n/Locale.ts","./UI/i18n/Translations":"UI/i18n/Translations.ts","./Logic/UIEventSource":"Logic/UIEventSource.ts","./Logic/Web/LocalStorageSource":"Logic/Web/LocalStorageSource.ts","./Logic/Web/QueryParameters":"Logic/Web/QueryParameters.ts"}],"UI/Base/SubtleButton.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts","../i18n/Translations":"UI/i18n/Translations.ts","./Combine":"UI/Base/Combine.ts","./FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/ShareScreen.ts":[function(require,module,exports) {
"use strict";
...
var CheckBox_1 = __importDefault(require("./Input/CheckBox"));
...
/** @class */
function (_super) {
  __extends(ShareScreen, _super);

  function ShareScreen(layout, layoutDefinition) {
    if (layout === void 0) {
      layout = undefined;
    }

    if (layoutDefinition === void 0) {
    ...
    layout = layout !== null && layout !== void 0 ? layout : (_b = (_a = State_1.default.state) === null || _a === void 0 ? void 0 : _a.layoutToUse) === null || _b === void 0 ? void 0 : _b.data;
    layoutDefinition = layoutDefinition !== null && layoutDefinition !== void 0 ? layoutDefinition : (_c = State_1.default.state) === null || _c === void 0 ? void 0 : _c.layoutDefinition;
    var tr = Translations_1.default.t.general.sharescreen;
    var optionCheckboxes = [];
    var optionParts = [];
    var includeLocation = new CheckBox_1.default(new Combine_1.default([Img_1.Img.checkmark, tr.fsIncludeCurrentLocation]), new Combine_1.default([Img_1.Img.no_checkmark, tr.fsIncludeCurrentLocation]), true);
    optionCheckboxes.push(includeLocation);
    var currentLocation = (_d = State_1.default.state) === null || _d === void 0 ? void 0 : _d.locationControl;
    optionParts.push(includeLocation.isEnabled.map(function (includeL) {
    ...
    if (State_1.default.state !== undefined) {
      var currentLayer_1 = State_1.default.state.bm.CurrentLayer;
      var currentBackground = new VariableUIElement_1.VariableUiElement(currentLayer_1.map(function (layer) {
        var _a;

        return tr.fsIncludeCurrentBackgroundMap.Subs({
          name: (_a = layer === null || layer === void 0 ? void 0 : layer.name) !== null && _a !== void 0 ? _a : ""
        }).Render();
      }));
      var includeCurrentBackground = new CheckBox_1.default(new Combine_1.default([Img_1.Img.checkmark, currentBackground]), new Combine_1.default([Img_1.Img.no_checkmark, currentBackground]), true);
      optionCheckboxes.push(includeCurrentBackground);
      optionParts.push(includeCurrentBackground.isEnabled.map(function (includeBG) {
        if (includeBG) {
          return "background=" + currentLayer_1.data.id;
        } else {
          return null;
        }
      }, [currentLayer_1]));
      var includeLayerChoices = new CheckBox_1.default(new Combine_1.default([Img_1.Img.checkmark, tr.fsIncludeCurrentLayers]), new Combine_1.default([Img_1.Img.no_checkmark, tr.fsIncludeCurrentLayers]), true);
      optionCheckboxes.push(includeLayerChoices);
      optionParts.push(includeLayerChoices.isEnabled.map(function (includeLayerSelection) {
        if (includeLayerSelection) {
          return Utils_1.Utils.NoNull(State_1.default.state.filteredLayers.data.map(fLayerToParam)).join("&");
        } else {
          return null;
        }
      }, State_1.default.state.filteredLayers.data.map(function (flayer) {
        return flayer.isDisplayed;
      })));
    }

    var switches = [{
      urlName: "fs-userbadge",
      human: tr.fsUserbadge
    }, {
      urlName: "fs-search",
      human: tr.fsSearch
    }, {
      urlName: "fs-welcome-message",
      human: tr.fsWelcomeMessage
    }, {
      urlName: "fs-layers",
      human: tr.fsLayers
    }, {
      urlName: "layer-control-toggle",
      human: tr.fsLayerControlToggle,
      reverse: true
    }, {
      urlName: "fs-add-new",
      human: tr.fsAddNew
    }, {
      urlName: "fs-geolocation",
      human: tr.fsGeolocation
    }];

    var _loop_1 = function _loop_1(swtch) {
      var checkbox = new CheckBox_1.default(new Combine_1.default([Img_1.Img.checkmark, Translations_1.default.W(swtch.human)]), new Combine_1.default([Img_1.Img.no_checkmark, Translations_1.default.W(swtch.human)]), !swtch.reverse);
      optionCheckboxes.push(checkbox);
      optionParts.push(checkbox.isEnabled.map(function (isEn) {
        if (isEn) {
          if (swtch.reverse) {
    ...
    for (var _i = 0, switches_1 = switches; _i < switches_1.length; _i++) {
      var swtch = switches_1[_i];

      _loop_1(swtch);
    }

    _this._options = new VerticalCombine_1.VerticalCombine(optionCheckboxes);
    var url = (currentLocation !== null && currentLocation !== void 0 ? currentLocation : new UIEventSource_1.UIEventSource(undefined)).map(function () {
      var literalText = "https://pietervdvn.github.io/MapComplete/" + layout.id.toLowerCase() + ".html";
      var parts = Utils_1.Utils.NoEmpty(Utils_1.Utils.NoNull(optionParts.map(function (eventSource) {
    ...
    _this.iframe = url.map(function (url) {
      var _a, _b;

      return "&lt;iframe src=\"" + url + "\" width=\"100%\" height=\"100%\" title=\"" + ((_b = (_a = layout.title) === null || _a === void 0 ? void 0 : _a.InnerRender()) !== null && _b !== void 0 ? _b : "MapComplete") + " with MapComplete\"&gt;&lt;/iframe&gt";
    });
    _this._iframeCode = new VariableUIElement_1.VariableUiElement(url.map(function (url) {
      var _a, _b;

      return "<span class='literal-code iframe-code-block'>\n                         &lt;iframe src=\"" + url + "\" width=\"100%\" height=\"100%\" title=\"" + ((_b = (_a = layout.title) === null || _a === void 0 ? void 0 : _a.InnerRender()) !== null && _b !== void 0 ? _b : "MapComplete") + " with MapComplete\"&gt;&lt;/iframe&gt \n                    </span>";
    }));
    _this._editLayout = new FixedUiElement_1.FixedUiElement("");

    if (layoutDefinition !== undefined && ((_e = State_1.default.state) === null || _e === void 0 ? void 0 : _e.osmConnection) !== undefined) {
      _this._editLayout = new VariableUIElement_1.VariableUiElement(State_1.default.state.osmConnection.userDetails.map(function (userDetails) {
        if (userDetails.csCount <= State_1.default.userJourney.themeGeneratorReadOnlyUnlock) {
          return "";
        }

        return new SubtleButton_1.SubtleButton("./assets/pencil.svg", new Combine_1.default([tr.editThisTheme.SetClass("bold"), "<br/>", tr.editThemeDescription]), {
          url: "./customGenerator.html#" + State_1.default.state.layoutDefinition,
          newTab: true
        }).Render();
      }));
    }

    _this._linkStatus = new UIEventSource_1.UIEventSource("");

    _this.ListenTo(_this._linkStatus);

    var self = _this;
    _this._link = new VariableUIElement_1.VariableUiElement(url.map(function (url) {
      return "<input type=\"text\" value=\" " + url + "\" id=\"code-link--copyable\" style=\"width:90%\">";
    })).onClick(function () {
      return __awaiter(_this, void 0, void 0, function () {
        function rejected() {
          var copyText = document.getElementById("code-link--copyable"); // @ts-ignore

          copyText.select(); // @ts-ignore

          copyText.setSelectionRange(0, 99999);
          /*For mobile devices*/

          document.execCommand("copy");
          var copied = tr.copiedToClipboard;
        ...
        return __generator(this, function (_e) {
          shareData = {
            title: (_b = (_a = Translations_1.default.W(layout.id)) === null || _a === void 0 ? void 0 : _a.InnerRender()) !== null && _b !== void 0 ? _b : "",
            text: (_d = (_c = Translations_1.default.W(layout.description)) === null || _c === void 0 ? void 0 : _c.InnerRender()) !== null && _d !== void 0 ? _d : "",
            url: self._link.data
          };

          try {
            navigator.share(shareData).then(function () {
              var thx = tr.thanksForSharing;
              thx.SetClass("thanks");

              _this._linkStatus.setData(thx);
  ...
  ShareScreen.prototype.InnerRender = function () {
    var tr = Translations_1.default.t.general.sharescreen;
    return new VerticalCombine_1.VerticalCombine([this._editLayout, tr.intro, this._link, Translations_1.default.W(this._linkStatus.data), tr.addToHomeScreen, tr.embedIntro, this._options, this._iframeCode]).Render();
  };
...
},{"./UIElement":"UI/UIElement.ts","./i18n/Translations":"UI/i18n/Translations.ts","./Base/FixedUiElement":"UI/Base/FixedUiElement.ts","./Base/Combine":"UI/Base/Combine.ts","./Base/VariableUIElement":"UI/Base/VariableUIElement.ts","./Input/CheckBox":"UI/Input/CheckBox.ts","./Base/VerticalCombine":"UI/Base/VerticalCombine.ts","./Img":"UI/Img.ts","../State":"State.ts","../Utils":"Utils.ts","../Logic/UIEventSource":"Logic/UIEventSource.ts","./Base/SubtleButton":"UI/Base/SubtleButton.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","UI/ShareScreen.ts"], null)
//# sourceMappingURL=/UI/ShareScreen.js.map