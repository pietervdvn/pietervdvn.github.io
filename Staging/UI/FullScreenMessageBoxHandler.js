...
exports.State = State;
},{"./Utils":"Utils.ts","./Logic/ElementStorage":"Logic/ElementStorage.ts","./Logic/Osm/Changes":"Logic/Osm/Changes.ts","./Logic/Osm/OsmConnection":"Logic/Osm/OsmConnection.ts","./UI/i18n/Locale":"UI/i18n/Locale.ts","./UI/i18n/Translations":"UI/i18n/Translations.ts","./Logic/UIEventSource":"Logic/UIEventSource.ts","./Logic/Web/LocalStorageSource":"Logic/Web/LocalStorageSource.ts","./Logic/Web/QueryParameters":"Logic/Web/QueryParameters.ts"}],"UI/FullScreenMessageBoxHandler.ts":[function(require,module,exports) {
"use strict";
...
exports.FullScreenMessageBox = void 0;
...
/** @class */
function (_super) {
  __extends(FullScreenMessageBox, _super);

  function FullScreenMessageBox(onClear) {
    var _this = _super.call(this, undefined) || this;

    var self = _this;
    State_1.State.state.fullScreenMessage.addCallbackAndRun(function (uiElement) {
      _this._uielement = new Combine_1.default([State_1.State.state.fullScreenMessage.data]).SetStyle("display:block;" + "padding: 1em;" + "padding-bottom:6em;" + ("margin-bottom:" + FullScreenMessageBox._toTheMap_height + ";") + "box-sizing:border-box;" + ("height:calc(100vh - " + FullScreenMessageBox._toTheMap_height + ");") + "overflow-y: auto;" + "max-width:100vw;" + "overflow-x:hidden;" + "background:white;");
    });

    _this.ListenTo(State_1.State.state.fullScreenMessage);

    _this.HideOnEmpty(true);

    State_1.State.state.fullScreenMessage.addCallback(function (latestData) {
    ...
    if (window !== undefined) {
      window.onhashchange = function () {
        ...
        if (location.hash === "") {
          ...
          (_a = self._uielement) === null || _a === void 0 ? void 0 : _a.setData(undefined);
          onClear();
        }
      };
    }

    _this.returnToTheMap = new Combine_1.default([Translations_1.default.t.general.returnToTheMap.Clone().SetStyle("font-size:xx-large")]).SetStyle("background:#7ebc6f;" + "position: fixed;" + "z-index: 10000;" + "bottom: 0;" + "left: 0;" + ("height: " + FullScreenMessageBox._toTheMap_height + ";") + "width: 100vw;" + "color: white;" + "font-weight: bold;" + "pointer-events: all;" + "cursor: pointer;" + "padding-top: 1.2em;" + "text-align: center;" + "padding-bottom: 1.2em;" + "box-sizing:border-box").onClick(function () {
      console.log("Returning...");
      State_1.State.state.fullScreenMessage.setData(undefined);
      onClear();
      self.Update();
    });
    return _this;
  ...
  FullScreenMessageBox.prototype.InnerRender = function () {
    if (State_1.State.state.fullScreenMessage.data === undefined) {
      return "";
    }

    return new Combine_1.default([this._uielement, this.returnToTheMap]).Render();
  };

  FullScreenMessageBox._toTheMap_height = "5em";
  return FullScreenMessageBox;
}(UIElement_1.UIElement);

exports.FullScreenMessageBox = FullScreenMessageBox;
},{"./UIElement":"UI/UIElement.ts","./i18n/Translations":"UI/i18n/Translations.ts","../State":"State.ts","./Base/Combine":"UI/Base/Combine.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
