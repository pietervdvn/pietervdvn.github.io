...
},{"../Utils":"Utils.ts"}],"Customizations/OnlyShowIf.ts":[function(require,module,exports) {
"use strict";
...
},{"../Logic/Tags":"Logic/Tags.ts","../UI/UIElement":"UI/UIElement.ts"}],"Logic/Web/LocalStorageSource.ts":[function(require,module,exports) {
"use strict";
...
},{"./Translation":"UI/i18n/Translation.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"Customizations/TagRenderingOptions.ts":[function(require,module,exports) {
"use strict";
...
},{"../Logic/Tags":"Logic/Tags.ts","./OnlyShowIf":"Customizations/OnlyShowIf.ts","../UI/i18n/Translations":"UI/i18n/Translations.ts"}],"Customizations/Questions/OsmLink.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  OsmLink.options = {
    ...
    mappings: [{
      k: new Tags_1.RegexTag("id", /node\/-.+/),
      txt: ""
    }]
  };
  return OsmLink;
}(TagRenderingOptions_1.TagRenderingOptions);

exports.OsmLink = OsmLink;
},{"../../UI/Img":"UI/Img.ts","../../Logic/Tags":"Logic/Tags.ts","../TagRenderingOptions":"Customizations/TagRenderingOptions.ts"}],"Customizations/Questions/WikipediaLink.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  WikipediaLink.options = {
    ...
    freeform: {
      key: "wikipedia",
      template: "$$$",
      renderTemplate: "<a href='{wikipedia}' target='_blank'>" + "<img style='width: 24px;height: 24px;' src='./assets/wikipedia.svg' alt='wikipedia'>" + "</a>",
      placeholder: ""
    }
  };
...
},{"../TagRenderingOptions":"Customizations/TagRenderingOptions.ts"}],"Logic/ElementStorage.ts":[function(require,module,exports) {
"use strict";
...
},{"./Utils":"Utils.ts","./Logic/ElementStorage":"Logic/ElementStorage.ts","./Logic/Osm/Changes":"Logic/Osm/Changes.ts","./Logic/Osm/OsmConnection":"Logic/Osm/OsmConnection.ts","./UI/i18n/Locale":"UI/i18n/Locale.ts","./UI/i18n/Translations":"UI/i18n/Translations.ts","./Logic/UIEventSource":"Logic/UIEventSource.ts","./Logic/Web/LocalStorageSource":"Logic/Web/LocalStorageSource.ts","./Logic/Web/QueryParameters":"Logic/Web/QueryParameters.ts"}],"UI/FeatureInfoBox.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function FeatureInfoBox(feature, tagsES, title, elementsToShow) {
    ...
    var renderedTitle;
    title = title !== null && title !== void 0 ? title : new TagRenderingOptions_1.TagRenderingOptions({
      mappings: [{
        k: new Tags_1.And([]),
        txt: ""
      }]
    ...
    if (typeof title == "string") {
      renderedTitle = new FixedUiElement_1.FixedUiElement(title);
    } else if (title instanceof UIElement_1.UIElement) {
      renderedTitle = title;
    } else {
      renderedTitle = title.construct(deps);
    }

    renderedTitle.SetStyle("width: calc(100% - 50px - 0.2em);").SetClass("title-font");
    var osmLink = new OsmLink_1.OsmLink().construct(deps).SetStyle("width: 24px; display:block;");
    var wikipedialink = new WikipediaLink_1.WikipediaLink().construct(deps).SetStyle("width: 24px; display:block;");
    _this._title = new Combine_1.default([renderedTitle, wikipedialink, osmLink]).SetStyle("display:flex;");
    return _this;
  }
  ...
  FeatureInfoBox.prototype.InnerRender = function () {
    ...
    var infoboxcontents = new Combine_1.default([new VerticalCombine_1.VerticalCombine(info).SetClass("infobox-information"), questionElement !== null && questionElement !== void 0 ? questionElement : ""]);
    return new Combine_1.default([this._title, "<div class='infoboxcontents'>", infoboxcontents, "</div>"]).Render();
  };
...
},{"./UIElement":"UI/UIElement.ts","./Base/VerticalCombine":"UI/Base/VerticalCombine.ts","../Customizations/Questions/OsmLink":"Customizations/Questions/OsmLink.ts","../Customizations/Questions/WikipediaLink":"Customizations/Questions/WikipediaLink.ts","../Logic/Tags":"Logic/Tags.ts","./i18n/Translations":"UI/i18n/Translations.ts","./Base/FixedUiElement":"UI/Base/FixedUiElement.ts","../State":"State.ts","../Customizations/TagRenderingOptions":"Customizations/TagRenderingOptions.ts","./Base/Combine":"UI/Base/Combine.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
