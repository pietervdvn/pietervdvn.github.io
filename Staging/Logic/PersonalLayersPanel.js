...
exports.Utils = Utils;
},{"./UI/UIElement":"UI/UIElement.ts"}],"Logic/ElementStorage.ts":[function(require,module,exports) {
"use strict";
...
},{"osm-auth":"node_modules/osm-auth/index.js","../UIEventSource":"Logic/UIEventSource.ts","./OsmPreferences":"Logic/Osm/OsmPreferences.ts","./ChangesetHandler":"Logic/Osm/ChangesetHandler.ts"}],"UI/Base/FixedUiElement.ts":[function(require,module,exports) {
"use strict";
  ...
  function Widths(carWidth, cyclistWidth, pedestrianWidth) {
    ...
    _this.elementsToShow = [new TagRenderingOptions_1.TagRenderingOptions({
      ...
      mappings: [{
        ...
        txt: "De totale nodige ruimte voor vlot en veilig verkeer is dus <span class='thanks'>{targetWidth}m</span>"
      }]
    }).OnlyShowIf(_this._notCarfree), new TagRenderingOptions_1.TagRenderingOptions({
      mappings: [{
...
var CheckBox_1 = require("../UI/Input/CheckBox");
...
function (_super) {
  ...
  function PersonalLayersPanel() {
    var _this = _super.call(this, State_1.State.state.favouriteLayers) || this;
    ...
    var self = _this;
    State_1.State.state.installedThemes.addCallback(function (extraThemes) {
  ...
  PersonalLayersPanel.prototype.UpdateView = function (extraThemes) {
    ...
    this.checkboxes = [];
    var favs = (_a = State_1.State.state.favouriteLayers.data) !== null && _a !== void 0 ? _a : [];
    ...
    State_1.State.state.favouriteLayers.addCallback(function (layers) {
      var _a;
  ...
  PersonalLayersPanel.prototype.InnerRender = function () {
    ...
    var userDetails = State_1.State.state.osmConnection.userDetails.data;
