...
exports.Utils = Utils;
},{"./UI/UIElement":"UI/UIElement.ts","jquery":"node_modules/jquery/dist/jquery.js","./UI/Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"Logic/ElementStorage.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIEventSource":"Logic/UIEventSource.ts","../../Utils":"Utils.ts"}],"Logic/Web/LocalStorageSource.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts","../../Logic/Web/LocalStorageSource":"Logic/Web/LocalStorageSource.ts"}],"Logic/Osm/ChangesetHandler.ts":[function(require,module,exports) {
"use strict";
...
},{"osm-auth":"node_modules/osm-auth/index.js","../UIEventSource":"Logic/UIEventSource.ts","./OsmPreferences":"Logic/Osm/OsmPreferences.ts","./ChangesetHandler":"Logic/Osm/ChangesetHandler.ts"}],"UI/Base/Combine.ts":[function(require,module,exports) {
"use strict";
...
},{"./Translation":"UI/i18n/Translation.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"Logic/Web/QueryParameters.ts":[function(require,module,exports) {
"use strict";
  ...
  function Layout(id, supportedLanguages, title, layers, startzoom, startLat, startLon, welcomeMessage, gettingStartedPlzLogin, welcomeBackMessage, welcomeTail) {
    if (gettingStartedPlzLogin === void 0) {
      gettingStartedPlzLogin = new Combine_1.default([Translations_1.default.t.general.getStartedLogin.SetClass("soft").onClick(function () {
        State_1.default.state.osmConnection.AttemptLogin();
    ...
    this.title = Translations_1.default.WT(title);
...
module.exports = {
  ...
  "overpassTags": {
    "and": ["amenity=drinking_water", "access!=permissive", "access!=private"]
  },
  "minzoom": 13,
  "wayHandling": 1,
  "presets": [{
...
function (_super) {
  ...
  function DeleteImage(key, tags) {
    ...
    var deleteButton = Translations_1.default.t.image.doDelete.Clone().SetStyle(style + "background:#ff8c8c;").onClick(function () {
      ...
      (_a = State_1.default.state) === null || _a === void 0 ? void 0 : _a.changes.addTag(tags.data.id, new Tags_1.Tag(key, ""));
    });
    var cancelButton = Translations_1.default.t.general.cancel;
    _this.deleteDialog = new CheckBox_1.default(new Combine_1.default([deleteButton, cancelButton]).SetStyle("display:flex;flex-direction:column;"), "<img src='./assets/delete.svg' style='width:1.5em;'>");
    return _this;
  }
...
function (_super) {
  ...
  function ImageUploadFlow(preferedLicense, uploadOptions) {
    var _this = _super.call(this, State_1.default.state.osmConnection.userDetails) || this;
    ...
    _this._connectButton = new Combine_1.default([t.pleaseLogin]).onClick(function () {
      return State_1.default.state.osmConnection.AttemptLogin();
  ...
  ImageUploadFlow.prototype.InnerRender = function () {
    ...
    if (State_1.default.state.osmConnection.userDetails === undefined) {
      return ""; // No user details -> logging in is probably disabled or smthing
    }

    if (!State_1.default.state.osmConnection.userDetails.data.loggedIn) {
  ...
  ImageUploadFlow.prototype.InnerUpdate = function (htmlElement) {
    ...
    var user = State_1.default.state.osmConnection.userDetails.data;
...
function () {
  ...
  OsmImageUploadHandler.prototype.generateOptions = function (license) {
    ...
    var description = ["author:" + State_1.default.state.osmConnection.userDetails.data.name, "license:" + license, "wikidata:" + tags.wikidata, "osmid:" + tags.id, "name:" + tags.name].join("\n");
    var changes = State_1.default.state.changes;
    return {
      title: title,
...
function (_super) {
  ...
  function ImageCarouselWithUpload(dependencies) {
    ...
    var license = State_1.default.state.osmConnection.GetPreference("pictures-license");
...
function () {
  ...
  FromJSON.getSharedLayers = function () {
    ...
    State_1.default.FromBase64 = FromJSON.FromBase64;
...
},{}],"assets/themes/shops/shops.json":[function(require,module,exports) {
module.exports = {
  "id": "shops",
  "title": {
    "en": "Open Shop Map"
...
var shops = __importStar(require("../assets/themes/shops/shops.json"));
...
},{"./JSON/FromJSON":"Customizations/JSON/FromJSON.ts","../assets/themes/bookcases/Bookcases.json":"assets/themes/bookcases/Bookcases.json","../assets/themes/aed/aed.json":"assets/themes/aed/aed.json","../assets/themes/toilets/toilets.json":"assets/themes/toilets/toilets.json","../assets/themes/artwork/artwork.json":"assets/themes/artwork/artwork.json","../assets/themes/cyclestreets/cyclestreets.json":"assets/themes/cyclestreets/cyclestreets.json","../assets/themes/ghostbikes/ghostbikes.json":"assets/themes/ghostbikes/ghostbikes.json","../assets/themes/cyclofix/cyclofix.json":"assets/themes/cyclofix/cyclofix.json","../assets/themes/buurtnatuur/buurtnatuur.json":"assets/themes/buurtnatuur/buurtnatuur.json","../assets/themes/nature/nature.json":"assets/themes/nature/nature.json","../assets/themes/maps/maps.json":"assets/themes/maps/maps.json","../assets/themes/shops/shops.json":"assets/themes/shops/shops.json","../Logic/PersonalLayout":"Logic/PersonalLayout.ts","./StreetWidth/StreetWidth":"Customizations/StreetWidth/StreetWidth.ts"}],"UI/Base/SubtleButton.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts","../i18n/Translations":"UI/i18n/Translations.ts","./Combine":"UI/Base/Combine.ts","./FixedUiElement":"UI/Base/FixedUiElement.ts"}],"Logic/PersonalLayersPanel.ts":[function(require,module,exports) {
"use strict";
...
exports.PersonalLayersPanel = void 0;
...
var CheckBox_1 = __importDefault(require("../UI/Input/CheckBox"));

var PersonalLayout_1 = require("./PersonalLayout");

var SubtleButton_1 = require("../UI/Base/SubtleButton");

var FixedUiElement_1 = require("../UI/Base/FixedUiElement");

var PersonalLayersPanel =
/** @class */
function (_super) {
  __extends(PersonalLayersPanel, _super);

  function PersonalLayersPanel() {
    var _this = _super.call(this, State_1.default.state.favouriteLayers) || this;

    _this.checkboxes = [];

    _this.ListenTo(State_1.default.state.osmConnection.userDetails);

    _this.UpdateView([]);

    var self = _this;
    State_1.default.state.installedThemes.addCallback(function (extraThemes) {
      self.UpdateView(extraThemes.map(function (layout) {
  ...
  PersonalLayersPanel.prototype.UpdateView = function (extraThemes) {
    var _a, _b, _c, _d, _e, _f, _g;

    this.checkboxes = [];
    var favs = (_a = State_1.default.state.favouriteLayers.data) !== null && _a !== void 0 ? _a : [];
    var controls = new Map();
    var allLayouts = AllKnownLayouts_1.AllKnownLayouts.layoutsList.concat(extraThemes);

    for (var _i = 0, allLayouts_1 = allLayouts; _i < allLayouts_1.length; _i++) {
      var layout = allLayouts_1[_i];

      if (layout.id === PersonalLayout_1.PersonalLayout.NAME) {
        continue;
      }

      var header = new Combine_1.default(["<img style=\"max-width: 3em;max-height: 3em; float: left; padding: 0.1em; margin-right: 0.3em;\" src='" + layout.icon + "'>", "<b>", layout.title, "</b><br/>", (_b = layout.description) !== null && _b !== void 0 ? _b : ""]).SetStyle("background: #eee; display: block; padding: 0.5em; border-radius:0.5em; overflow:auto;");
      ...
      var _loop_1 = function _loop_1(layer) {
        ...
        var icon = (_c = layer.icon) !== null && _c !== void 0 ? _c : "./assets/checkmark.svg";
        var iconUnset = (_d = layer.icon) !== null && _d !== void 0 ? _d : "";

        if (layer.icon !== undefined && typeof layer.icon !== "string") {
          icon = (_e = layer.icon.GetContent({
            "id": "node/-123456"
          }).txt) !== null && _e !== void 0 ? _e : "./assets/checkmark.svg";
          iconUnset = icon;
        }

        var name = (_f = layer.name) !== null && _f !== void 0 ? _f : layer.id;

        if (name === undefined) {
          return "continue";
        }

        var content = new Combine_1.default(["<b>", name, "</b> ", layer.description !== undefined ? new Combine_1.default(["<br/>", layer.description]) : ""]);
        var iconImage = "<img src=\"" + icon + "\">";
        var iconUnsetImage = "<img src=\"" + iconUnset + "\">";
        var cb = new CheckBox_1.default(new SubtleButton_1.SubtleButton(new FixedUiElement_1.FixedUiElement(iconImage).SetStyle(""), content), new SubtleButton_1.SubtleButton(new FixedUiElement_1.FixedUiElement(iconUnsetImage).SetStyle("opacity:0.1;"), new Combine_1.default(["<del>", content, "</del>"])), (_g = controls[layer.id]) !== null && _g !== void 0 ? _g : favs.indexOf(layer.id) >= 0);
        cb.SetClass("custom-layer-checkbox");
        controls[layer.id] = cb.isEnabled;
        cb.isEnabled.addCallback(function (isEnabled) {
          var favs = State_1.default.state.favouriteLayers;
        ...
        this_1.checkboxes.push(cb);
      };

      var this_1 = this;

      for (var _h = 0, _j = layout.layers; _h < _j.length; _h++) {
        var layer = _j[_h];
    ...
    State_1.default.state.favouriteLayers.addCallback(function (layers) {
      var _a;

      for (var _i = 0, layers_1 = layers; _i < layers_1.length; _i++) {
        var layerId = layers_1[_i];
        (_a = controls[layerId]) === null || _a === void 0 ? void 0 : _a.setData(true);
      }
    });
  };

  PersonalLayersPanel.prototype.InnerRender = function () {
    var t = Translations_1.default.t.favourite;
    var userDetails = State_1.default.state.osmConnection.userDetails.data;

    if (!userDetails.loggedIn) {
      return t.loginNeeded.Render();
    }

    return new Combine_1.default(__spreadArrays([t.panelIntro], this.checkboxes)).Render();
  };

  return PersonalLayersPanel;
}(UIElement_1.UIElement);

exports.PersonalLayersPanel = PersonalLayersPanel;
},{"../UI/UIElement":"UI/UIElement.ts","../State":"State.ts","../UI/i18n/Translations":"UI/i18n/Translations.ts","../Customizations/AllKnownLayouts":"Customizations/AllKnownLayouts.ts","../UI/Base/Combine":"UI/Base/Combine.ts","../UI/Input/CheckBox":"UI/Input/CheckBox.ts","./PersonalLayout":"Logic/PersonalLayout.ts","../UI/Base/SubtleButton":"UI/Base/SubtleButton.ts","../UI/Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","Logic/PersonalLayersPanel.ts"], null)
//# sourceMappingURL=/Logic/PersonalLayersPanel.js.map